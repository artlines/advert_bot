...
|
*/
$config['base_url'] = 'http://advert.artline.me';
...
define('NAME',      'akrist.ru');
define('EMAIL',     'info@akrist.ru');
define('TMP',       '~/tmp/');
...
$config['valid_sort'] = [
  'name'              => 'Наименованию',
  'manufacturer_name' => 'Бренду',
  'price'             => 'Цене'
];
$config['valid_sdir']   = array('asc', 'desc');
$config['valid_limit']  = array('12', '24', '36');

$config['default_sort']   = 'name';
$config['default_sdir']   = 'asc';
$config['default_limit']  = '24';

define('USER_TYPE_FIZ', 1);
define('USER_TYPE_UR',  2);

define('USER_V_NAME',   1);   // 1  Название организации
define('USER_V_CITY',   2);   // 2  Город
define('USER_V_URADDR', 3);   // 3  Юридический адрес
define('USER_V_INN',    4);   // 4  ИНН
define('USER_V_KPP',    5);   // 5  КПП
define('USER_V_PHONE',  10);  // 10 Телефон
define('USER_V_FIO',    12);  // 12 ФИО
define('USER_V_STREET', 17);  // 17 Улица, дом/корпус
define('USER_V_ROOM',   18);  // 18 Подъезд, этаж, квартира
